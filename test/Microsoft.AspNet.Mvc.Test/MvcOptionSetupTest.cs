...
namespace Microsoft.AspNet.Mvc
{
    public class MvcOptionSetupTest
    {
        ...
        public void Setup_SetsUpModelBinders()
        {
            ...
            Assert.Equal(typeof(ServicesModelBinder), mvcOptions.ModelBinders[0].OptionType);
            Assert.Equal(typeof(BodyModelBinder), mvcOptions.ModelBinders[1].OptionType);
            Assert.Equal(typeof(TypeConverterModelBinder), mvcOptions.ModelBinders[2].OptionType);
            Assert.Equal(typeof(TypeMatchModelBinder), mvcOptions.ModelBinders[3].OptionType);
            Assert.Equal(typeof(CancellationTokenModelBinder), mvcOptions.ModelBinders[4].OptionType);
            Assert.Equal(typeof(ByteArrayModelBinder), mvcOptions.ModelBinders[5].OptionType);
            Assert.Equal(typeof(GenericModelBinder), mvcOptions.ModelBinders[6].OptionType);
            Assert.Equal(typeof(MutableObjectModelBinder), mvcOptions.ModelBinders[7].OptionType);
            Assert.Equal(typeof(ComplexModelDtoModelBinder), mvcOptions.ModelBinders[8].OptionType);
        }
